...
// Adapter defines core logging methods | 核心日志输出接口
...
// AdapterControl defines log configuration methods | 日志控制接口（用于配置级别、前缀、输出等）
type AdapterControl interface {
	...
	SetStdout(enable bool)   // Enable/disable console output | 设置终端输出开关
